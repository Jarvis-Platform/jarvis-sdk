...
def main():
    ...
    parser.add_argument(
        "arguments", help="Arguments for the executed command", nargs=argparse.REMAINDER)
    ...
    if args.command == "config":
        ...
        jarvis_project.process(args.arguments)
        ...
        jarvis_configuration_manager.process(arguments=args.arguments, jarvis_sdk_version=__version__)
    ...
    #     if len(args.arguments) > 0:
    #         if (args.arguments)[0] == "configuration":
    #             jarvis_configuration_manager.process(arguments=args.arguments)
